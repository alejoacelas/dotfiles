...
- Local: `~/best/work/tools/active/gdoc/fidelity-tests/`, same tree, holding prompts,
...
Update `INDEX.md`, push it to `gdt INDEX`, commit the local folder (`work/tools` is
private). Keep old runs.
