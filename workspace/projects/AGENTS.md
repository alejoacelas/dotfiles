...
Start every new project in `live/`. Organize it after two weeks without edits or on demand into
...
After two weeks without edits in `live/`, or when asked, read the project, commit pending work,
